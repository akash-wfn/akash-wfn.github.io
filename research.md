...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px; flex-wrap: wrap;">
    ...
    <div style="flex-shrink: 0; width: 250px; margin: auto;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/respic/click_chem.png" alt="Click Chemistry" style="width: 100%;">
    </div>
</div>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px; flex-wrap: wrap;">
    <div style="flex-shrink: 0; width: 250px; margin: auto;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/respic/dft.png" alt="Dynamic Reactions" style="width: 100%;">
    </div>
    <div style="flex: 1; min-width: 300px;">
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px; flex-wrap: wrap;">
    ...
    <div style="flex-shrink: 0; width: 250px; margin: auto;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/respic/multimodal-sufex.png" alt="Entropy vs Enthalpy" style="width: 100%;">
    </div>
</div>
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px; flex-wrap: wrap;">
    <div style="flex-shrink: 0; width: 250px; margin: auto;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/research/your-image-4.png" alt="Enthalpy Contributions" style="width: 100%;">
    </div>
    <div style="flex: 1; min-width: 300px;">
...
<div style="display: flex; gap: 20px; align-items: flex-start; margin-bottom: 30px; flex-wrap: wrap;">
    ...
    <div style="flex-shrink: 0; width: 250px; margin: auto;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/research/your-image-5.png" alt="Modeling Entropy" style="width: 100%;">
    </div>
</div>
