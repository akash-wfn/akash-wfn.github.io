...
{% include research_theme.html
    title="1. Expanding Click Chemistry with SuFEx and SuPhenEx"
    image_path="/images/respic/click_chem.png"
    align="right"
    text="The Nobel Prize-winning concept of 'click chemistry' has transformed how scientists build molecules. My work builds upon this foundation by exploring and expanding a powerful new variant: the Sulfur(VI) Phenolate Exchange (SuPhenEx) reaction. By replacing fluoride with a wide range of phenols, SuPhenEx offers a more versatile, synthetically appealing, and environmentally friendly approach to creating advanced materials and molecules."
%}

{% include research_theme.html
    title="2. Highlight: Dynamic, Fast, and Enantiospecific Reactions"
    image_path="/images/respic/dft.png"
    align="left"
...
{% include research_theme.html
    title="3. The Surprise: Uncovering the Dominant Role of Entropy"
    image_path="/images/respic/multimodal-sufex.png"
    align="right"
